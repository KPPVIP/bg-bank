	...
	Citizen.CreateThread(function()
		while true do
			...
			if nearBank() or nearATM() then
					DisplayHelpText('Drücke E um die dein Konto zu verwalten')
...
RegisterNUICallback('deposit', function(data)
	...
	TriggerServerEvent('bank:balance')
	ESX.ShowNotification(red, 'Du hast ' ..data.amount.. '$ eingezahlt')
end)
...
RegisterNUICallback('withdrawl', function(data)
	...
	TriggerServerEvent('bank:balance')
	ESX.ShowNotification(red, 'Du hast ' ..data.amountw.. '$ ausgezahlt')
end)
...
RegisterNUICallback('transfer', function(data)
	...
	TriggerServerEvent('bank:balance')
	ESX.ShowNotification(red, 'Du hast ' ..data.amountt.. '$ zu ID ' ..data.to.. ' Überwiesen!')
end)
